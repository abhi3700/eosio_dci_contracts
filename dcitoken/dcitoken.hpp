...
CONTRACT dcitoken : public contract {

public:
	using contract::contract;

	// dcitoken(name receiver, name code, datastream<const char*> ds) : 
	...
	*/
	...
	using create_action  = action_wrapper<"create"_n, &dcitoken::create>;
	using issuer_action  = action_wrapper<"issue"_n, &dcitoken::issue>;
	using retire_action  = action_wrapper<"retire"_n, &dcitoken::retire>;
	using transfer_action  = action_wrapper<"transfer"_n, &dcitoken::transfer>;
	using open_action  = action_wrapper<"open"_n, &dcitoken::open>;
	using close_action  = action_wrapper<"close"_n, &dcitoken::close>;
