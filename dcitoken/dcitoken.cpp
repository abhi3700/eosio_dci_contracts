#include "dcitoken.hpp"

// --------------------------------------------------------------------------------------------------------------------
void dcitoken::create( const name& issuer,
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::issue( const name& to,
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::retire( const asset& quantity,
						const string& memo )
{
	auto sym = quantity.symbol;
	check( sym.is_valid(), "invalid symbol name" );
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::transfer( const name& from,
							const name& to,
							const asset& quantity,
							const string& memo)
{
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::add_balance( const name& owner,
							const asset& value,
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::sub_balance( const name& owner,
							const asset& value)
{
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::open( const name& owner, 
						const symbol& symbol,
						const name& ram_payer )
{
...
// --------------------------------------------------------------------------------------------------------------------
void dcitoken::close( const name& owner,
						const symbol& symbol)
{
	require_auth( owner );
	accounts_index acnts( get_self(), owner.value);
